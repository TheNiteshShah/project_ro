<div class="content-wrapper">
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="<?php echo base_url() ?>dcadmin/Reminders/view_reminders"><i class="fa fa-rotate-left"></i> View Reminder </a></li>
        </ol>
    </section>
            ...
            <div class="col-lg-12">
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <div class="col-lg-10">
                            <form action=" <?php echo base_url()  ?>dcadmin/Reminders/add_reminder_data/<? echo base64_encode(1);  ?>" method="POST" id="slide_frm" enctype="multipart/form-data">
                                <div class="table-responsive">
                                    <table class="table table-hover">
                                        ...
                                        <tr>
                                            ...
                                            <td> <input type="date" id="date" name="date" class="form-control" placeholder="" value="" required /> </td>
                                        </tr>
                                        <tr>
                                            <td colspan="2">
