        ...
        Team
          ...
          <ol class="breadcrumb">
           <li><a href="<?php echo base_url() ?>dcadmin/home"><i class="fa fa-dashboard"></i> Dashboard</a></li>
            <li><a href="<?php echo base_url() ?>dcadmin/system/view_team"><i class="fa fa-rotate-left"></i> View Team </a></li>
       ...
       <div class="col-lg-12">
                ...
                <?php echo $this->session->flashdata('emessage'); ?>
                  ...
                  <?php } ?>
                            ...
                            <li><a href="javascript:void(0);" class="dCnf" mydata="<?php echo $i ?>">Delete User</a></li>
                            </ul>
                          </div>
                        </div>
                            ...
                            <div style="display:none" id="cnfbox<?php echo $i ?>">
                              ...
                              <a href="javasript:void(0);" class="cans btn btn-default" mydatas="<?php echo $i ?>" >No</a>
                            </div>
                        </td>
                                            </tr>
                    <?php $i++; } ?>
